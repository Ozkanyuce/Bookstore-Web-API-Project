...
resource "aws_instance" "tf-docker-ec2" {
  ...
  key_name        = "First_Key"
  security_groups = ["ozkan-docker-sec-grp-203"]
  tags = {
  ...
  user_data  = <<-EOF
           ...
           TOKEN=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
           FOLDER="https://$TOKEN@raw.githubusercontent.com/Ozkanyuce/bookstore-repo/main/"
